...
class YOLO(object):
    _defaults = {
        "model_path"        : 'logs/Epoch50-Total_Loss19.6042-Val_Loss0.0000.pth',
        "classes_path"      : 'model_data/person_class.txt',
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            # update person rect
            rect_list.append([top, left, bottom, right])
